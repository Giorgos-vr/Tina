...
Για να εγκαταστήσετε την εφαρμογή αυτή αρκεί να κατεβάσετε και να αποσυμπιέσετε το αρχείο [tina_alpha.zip](https://drive.google.com/file/d/155AP-49uSlqUJuZzOqr5S5b0mQiGpekl/view?usp=sharing) και να τρέξετε την συντόμευση 'Tina' που θα βρείτε στον κεντρικό φάκελο.
